/* masterUI.js — compatibility wrapper (loads canonical kebab-case file)
   Keeps older references working while canonical file is `master-ui.js`. */

(function () {
    if (typeof window === 'undefined') return;
    if (window.appMasterUI) return;
    try {
        const s = document.createElement('script');
        s.src = 'js/ui/master-ui.js';
        s.async = false;
