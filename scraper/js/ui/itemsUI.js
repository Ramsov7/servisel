/* itemsUI.js — compatibility wrapper (loads canonical kebab-case file)
   Keeps older references working while canonical file is `items-ui.js`. */

(function () {
    if (typeof window === 'undefined') return;
    // If canonical implementation already present, nothing to do
    if (window.appItemsUI) return;
    try {
        const s = document.createElement('script');
        s.src = 'js/ui/items-ui.js';
