/* sparepartUI.js — compatibility wrapper (loads canonical kebab-case file)
   Keeps older references working while canonical file is `sparepart-ui.js`. */

(function () {
    if (typeof window === 'undefined') return;
    if (window.appSparepartUI) return;
    try {
        const s = document.createElement('script');
        s.src = 'js/ui/sparepart-ui.js';
        s.async = false;
