...
/* expensesApi.js — placeholder after kebab-case refactor
    Original archived to archive/rename-backup-20251013/js/api/expensesApi.original.js
    Use `js/api/expenses-api.js` (kebab-case) instead.
*/
